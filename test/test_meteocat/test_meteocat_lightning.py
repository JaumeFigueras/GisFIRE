...
def test_lightning_01() -> None:
    ...
    assert lightning._latitude_epsg_4258 is None
    assert lightning._longitude_epsg_4258 is None
    assert lightning.geometry_epsg_4258 is None
    ...
    assert not lightning.hit_ground
    assert lightning.municipality_code is None
    assert lightning._latitude_epsg_4258 == 73.45
    assert lightning._longitude_epsg_4258 is None
    assert lightning.geometry_epsg_4258 is None
    ...
    assert lightning.municipality_code is None
    assert lightning._latitude_epsg_4258 is None
    assert lightning._longitude_epsg_4258 == 123.45
    assert lightning.geometry_epsg_4258 is None
    lightning = MeteocatLightning(date=datetime.datetime(2024, 4, 1, 15, 34, 56, tzinfo=pytz.UTC),
    ...
    assert lightning.date == datetime.datetime(2024, 4, 1, 15, 34, 56, tzinfo=pytz.UTC)
    assert lightning._latitude_epsg_4326 == 41.77052639
    assert lightning._longitude_epsg_4326 == 2.18969857
    assert lightning.geometry_epsg_4326 == "SRID=4326;POINT(2.18969857 41.77052639)"
    assert lightning.meteocat_id == 123456789
    ...
    assert lightning.hit_ground
    assert lightning.municipality_code == '08233'
    assert lightning._latitude_epsg_4258 == 41.77052639
    assert lightning._longitude_epsg_4258 == 2.18969857
    assert lightning.geometry_epsg_4258 == "SRID=4258;POINT(2.18969857 41.77052639)"
...
def test_lightning_02() -> None:
    ...
    with pytest.raises(ValueError):
        _ = MeteocatLightning(date=datetime.datetime(2024, 4, 1, 15, 34, 56, tzinfo=pytz.UTC), meteocat_id=123456789,
...
def test_lightning_latitude_etrs89_01() -> None:
    ...
    lightning = MeteocatLightning(date=datetime.datetime(2024, 4, 1, 15, 34, 56, tzinfo=pytz.UTC),
                                  ...
                                  municipality_code='08233', latitude_epsg_4258=41.77052639,
                                  longitude_epsg_4258=2.18969857)
    assert lightning.latitude_epsg_4258 == 41.77052639
    lightning.latitude_epsg_4258 = 2.18969857
    assert lightning._latitude_epsg_4258 == 2.18969857
    assert lightning.geometry_epsg_4258 == "SRID=4258;POINT(2.18969857 2.18969857)"
    assert lightning._latitude_epsg_4326 == 2.18969857
    assert lightning.geometry_epsg_4326 == "SRID=4326;POINT(2.18969857 2.18969857)"
    lightning = MeteocatLightning(date=datetime.datetime(2024, 4, 1, 15, 34, 56, tzinfo=pytz.UTC),
                                  meteocat_id=123456789, peak_current=57.45, chi_squared=23.12, ellipse_major_axis=3500,
                                  ellipse_minor_axis=500, ellipse_angle=23.45, number_of_sensors=2, hit_ground=True,
                                  municipality_code='08233', latitude_epsg_4258=41.77052639,
                                  longitude_epsg_4258=2.18969857)
    assert lightning.latitude_epsg_4258 == 41.77052639
    lightning.latitude_epsg_4258 = None
    assert lightning._latitude_epsg_4258 is None
    assert lightning.geometry_epsg_4258 is None
    assert lightning._latitude_epsg_4326 is None
    assert lightning.geometry_epsg_4326 is None
    lightning.latitude_epsg_4258 = 2.18969857
    assert lightning._latitude_epsg_4258 == 2.18969857
    assert lightning.geometry_epsg_4258 == "SRID=4258;POINT(2.18969857 2.18969857)"
    ...
    lightning = MeteocatLightning(date=datetime.datetime(2024, 4, 1, 15, 34, 56, tzinfo=pytz.UTC),
                                  ...
                                  longitude_epsg_4258=2.18969857)
    assert lightning.latitude_epsg_4258 == 41.77052639
    assert lightning.longitude_epsg_4258 == 2.18969857
    lightning._longitude_epsg_4258 = None
    lightning.latitude_epsg_4258 = 23.45
    assert lightning.geometry_epsg_4258 is None
    assert lightning._latitude_epsg_4326 is None
    assert lightning._longitude_epsg_4326 is None
    assert lightning.geometry_epsg_4326 is None
...
def test_lightning_latitude_etrs89_02() -> None:
    ...
    assert lightning.latitude_epsg_4258 == 41.77052639
    with pytest.raises(ValueError):
        lightning.latitude_epsg_4258 = 222.18969857
...
def test_lightning_longitude_etrs89_01() -> None:
    ...
    assert lightning.longitude_epsg_4258 == 41.77052639
    lightning.longitude_epsg_4258 = 2.18969857
    assert lightning._longitude_epsg_4258 == 2.18969857
    assert lightning.geometry_epsg_4258 == "SRID=4258;POINT(2.18969857 2.18969857)"
    assert lightning._longitude_epsg_4326 == 2.18969857
    assert lightning.geometry_epsg_4326 == "SRID=4326;POINT(2.18969857 2.18969857)"
    lightning = MeteocatLightning(date=datetime.datetime(2024, 4, 1, 15, 34, 56, tzinfo=pytz.UTC),
                                  ...
                                  longitude_epsg_4258=41.77052639)
    assert lightning.longitude_epsg_4258 == 41.77052639
    lightning.longitude_epsg_4258 = None
    assert lightning._longitude_epsg_4258 is None
    assert lightning.geometry_epsg_4258 is None
    assert lightning._longitude_epsg_4326 is None
    assert lightning.geometry_epsg_4326 is None
    ...
    assert lightning.latitude_epsg_4258 == 41.77052639
    assert lightning.longitude_epsg_4258 == 2.18969857
    lightning._latitude_epsg_4258 = None
    lightning.longitude_epsg_4258 = 23.45
    assert lightning.geometry_epsg_4258 is None
    assert lightning._latitude_epsg_4326 is None
    assert lightning._longitude_epsg_4326 is None
    assert lightning.geometry_epsg_4326 is None
...
def test_lightning_longitude_etrs89_02() -> None:
    ...
    assert lightning.longitude_epsg_4258 == 2.18969857
    with pytest.raises(ValueError):
        lightning.longitude_epsg_4258 = 222.18969857
...
def test_geometries_01(db_session: Session, data_provider_list: Union[List[DataProvider], None]) -> None:
    ...
    assert lightning.geometry_epsg_4258.srid == 4258
    point: Point = lightning.geometry_epsg_4258_as_point
    assert point.x == 2.18969857
    assert point.y == 41.77052639
    assert lightning.geometry_epsg_25831.srid == 25831
    point: Point = lightning.geometry_epsg_25831_as_point
