...
.. code-block:: bash
   ...
   ssh user@server
   cd ~/GisFIRE
   nohup .venv/bin/python -u -m src.apps.statistics.wildfires.catalonia_darpa.wildfire_statistics \
       --csv burnt.csv \
       > catalonia_darpa_wildfire_statistics.log 2>&1 < /dev/null &
   exit
...
.. code-block:: bash
   ...
   ssh user@server 'pgrep -af catalonia_darpa.wildfire_statistics; tail -n 20 GisFIRE/catalonia_darpa_wildfire_statistics.log'
